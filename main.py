...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--images_path', type=str, help="Path to where the images of the dataset are kept",
                        required = True)
    parser.add_argument('-a', '--annotations_path', type=str, help="Path to where the annotations of the dataset are kept",
                        required=True)
    parser.add_argument('-b', '--batch_size', type=int, default=16, help="Size of the batch you want to train on.")
    parser.add_argument('-e', '--epoch_num', type=int, default=100, help="Num of training epochs.")
